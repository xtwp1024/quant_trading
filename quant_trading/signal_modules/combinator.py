...
-----
```python
from quant_trading.signal_modules.combinator import WeightedAverageCombinator, VotingCombinator
from quant_trading.signal_modules.generators import RSIGenerator, MACDGenerator
